...
import { Autocomplete, Button, Checkbox, Container, FormHelperText, Grid, InputLabel, ListItemText, MenuItem, Select, TextField } from '@mui/material';
...
import { AddItemValidation } from '../../utils/formValidationSchemas';
...
const AddItem = () => {
    ...
    return (
        <div className='comnpadding'>
            <Container className='add_list_box'>
                <h2 className='comntitle'>add your New listing</h2>
                        ...
                        <Autocomplete
                            ...
                            renderInput={(params) => (
                                <TextField
                                    ...
                                    error={!!errors?.sub_categories_id?.message}
                                    helperText={errors?.sub_categories_id?.message}
                                    {...params}
