...
@section('page_title', 'Group Create')
                        ...
                        <form class="forms-sample material-form" name="groupForm" id="groupForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="group_document[]" required="required" multiple onchange="previewImages(event)"/>
                                    </div>
                                    <div id="imagePreview" class="row mt-3"></div> <!-- Container for image previews -->
                                    <div class="form-group">
